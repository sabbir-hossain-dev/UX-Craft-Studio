...
export default function Footer() {
  return (
    <div className="bg-white pt-12"> {/* Ei white background wrapper ta black issue ta fix korbe */}
      <footer className="bg-[#0B47B3] text-white pt-20 pb-8 px-6 font-sans rounded-t-[2.5rem] shadow-[0_-10px_40px_rgba(11,71,179,0.15)] relative z-20">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-16">
            ...
            {/* Column 2: Company */}
            <div>
              <h4 className="font-bold text-lg mb-6 tracking-wide uppercase">Company</h4>
              <ul className="space-y-4">
                {['About Us', 'Our Work', 'Case Studies', 'Blog', 'Careers', 'Contact Us'].map((item) => (
                  <li key={item}>
                    <Link href="#" className="text-blue-100/90 hover:text-white transition-colors text-sm flex items-center gap-3">
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="opacity-70"><path d="m9 18 6-6-6-6"/></svg>
                      {item}
                    </Link>
                  </li>
                ))}
            ...
            {/* Column 3: Services */}
            <div>
              <h4 className="font-bold text-lg mb-6 tracking-wide uppercase">Services</h4>
              <ul className="space-y-4">
            ...
            {/* Column 4: Resources */}
            <div>
              <h4 className="font-bold text-lg mb-6 tracking-wide uppercase">Resources</h4>
              <ul className="space-y-4">
            ...
            <div>
              <h4 className="font-bold text-lg mb-6 tracking-wide uppercase">Get In Touch</h4>
              <ul className="space-y-5 text-sm text-blue-100/90">
          ...
          <div className="border-y border-white/20 py-10 mb-8 flex flex-col lg:flex-row justify-between items-center gap-8">
            <div className="flex items-center gap-5 w-full lg:w-1/2">
              ...
              <div>
                ...
                <p className="text-blue-100/90 text-sm leading-relaxed">Subscribe to our newsletter for the latest insights, tips, and industry updates.</p>
              </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex justify-end">
              <form className="flex w-full max-w-md">
                <input 
                  ...
                  className="w-full bg-[#093d96] border border-white/20 text-white placeholder-blue-200/60 px-6 py-4 rounded-l-xl focus:outline-none focus:border-white/50 transition-colors text-sm"
                  required
                />
                <button 
                  type="submit" 
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-blue-100/80">
